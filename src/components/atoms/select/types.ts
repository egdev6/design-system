...
type SelectVariant = VariantProps<typeof selectVariant>['variant'];
type SelectTypeVariant = 'text' | 'email' | 'password' | 'number' | 'tel' | 'url' | 'search' | 'hidden';
type SelectSize = VariantProps<typeof selectVariant>['size'];
